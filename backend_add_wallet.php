...
<table border="1">
			<tr>
				<td text-align="center">充值編號</td>
				<td text-align="center">充值帳號</td>
				<td text-align="center">充值金額</td>
				<td text-align="center">銀行</td>
				<td text-align="center">充值後金額</td>
				<td text-align="center">充值時間</td>
				<td text-align="center">是否完成充值</td>
			...
			while($row01 = mysqli_fetch_array($result01)){
                ...
                $addwallet_bank = $row01["addwallet_bank"];
            ...
            <tr>
                ...
                <td><?php echo $addwallet_bank;?></td>	<!-- 顯示銀行 -->
                <td><?php echo nl2br($addwallet_number_finish);?></td>	<!-- 顯示加值後金額 -->
                <td><?php echo $addwallet_time;?></td>	<!-- 充值時間 -->
                <td><?php echo $addwallet_done;?></td><!-- 顯示是否完成充值 -->
               
                <?php
                if ($addwallet_done != 'yes'){
                ?>
                <td><a href="backend_add_wallet_check.php?addwallet_id=<?php echo $addwallet_id;?>">充值</a></td>
